...
- `ans1_loop_over_lossy_slab_10MHz/` — **ANS-1**, commissioned 2026-08-09
  ...
  Waiting-on-you list).
- `ans3_two_torus_gap_ports_10MHz/` — **ANS-3**, commissioned 2026-08-16
...
- `ans4_birdcage_four_port_10_64_128MHz/` — **ANS-4**, commissioned 2026-08-30
