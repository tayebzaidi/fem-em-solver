...
def _write_comparison(m, z, s) -> Path:
    """``COMPARISON.md``: our columns filled, AED columns blank per SPEC.
    ...
    path.write_text(
        f"""# ANS-3 — comparison table (our half filled, AED half blank)
...
| Entry | Ours (FEM) | AED | AED vs ours |
|---|---|---|---|
| Z₁₁ | {_fmt(z[0, 0])} | | |
| Z₁₂ | {_fmt(z[0, 1])} | | |
| Z₂₁ | {_fmt(z[1, 0])} | | |
...
| Quantity | Exact | Ours (FEM) | Gate | AED |
|---|---|---|---|---|
