...
Generated by `03_two_torus_gap_ports_10MHz.py` on 2026-08-16T11:06:05Z; every
...
|---|---|---|---|
| Z₁₁ | +3.8189531e+00 +7.4349184e+00j | | |
| Z₁₂ | +8.6032274e-03 +1.1101559e+00j | | |
| Z₂₁ | +8.6249315e-03 +1.1108033e+00j | | |
| Z₂₂ | +3.8200359e+00 +7.1854461e+00j | | |

**Im Z₂₁ is the primary adjudication row.** Ours is
+1.1108033e+00 Ω against the filamentary closed form
ωM₁₂ = 1.241755 Ω — a ratio of 0.894543 raw and
0.939849 after the two named systematics
...
| Entry | Ours (FEM) | AED | AED vs ours |
|---|---|---|---|
| S₁₁ | -8.2258345e-01 +2.5156554e-01j | | |
| S₁₂ | +1.0310514e-02 +3.6178011e-02j | | |
| S₂₁ | +1.0317071e-02 +3.6198957e-02j | | |
| S₂₂ | -8.2480190e-01 +2.4340844e-01j | | |

## Identities

| Quantity | Exact | Ours (FEM) | Gate | AED |
|---|---|---|---|---|
| ‖S − Sᵀ‖/‖S‖ (reciprocity) | 0 | 2.5494e-05 | < 1e-03 | |
| \|Z₁₂ − Z₂₁\|/\|Z₂₁\| | 0 | 5.8309e-04 | reported | |
| ‖S‖₂ (passivity) | ≤ 1 | 0.861449 | ≤ 1.0 | |

## Negative control (in-fixture, ours)

The **raw** mutual ratio 0.894543 is printed first by the script and
...
|---|---|---|---|
| raw mutual ratio | 0.894543 | 0.894543 | 3.33e-07 |
| corrected mutual ratio | 0.939849 | 0.939849 | 3.23e-07 |
...
| Item | Ours (FEM) | AED |
|---|---|---|
| Elements | 178055 tetrahedra, lowest-order Nédélec edge elements (`N1curl`, degree 1) | |
| Adaptive passes | n/a — fixed graded mesh | |
| Final ΔS | n/a — single non-adaptive solve per port | |
| Solve time | 46.3 s for the 2-column sweep at `mpiexec -n 2` (+ 21.4 s for the export solve) | |
