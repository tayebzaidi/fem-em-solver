...
Generated by `01_loop_over_lossy_slab_10MHz.py` on 2026-08-09T18:38:41Z; every
...
|---|---|---|---|---|
| R, σ_slab = 100 S/m [Ω] | — (closed form gives ΔZ only) | +3.2770406e-01 | | |
| X, σ_slab = 100 S/m [Ω] | — | +9.0201082e+00 | | |
| R, σ_slab = 0 [Ω] | — | +0.0000000e+00 | | |
| X, σ_slab = 0 [Ω] | — | +9.5866871e+00 | | |
| **ΔR** [Ω] | +3.2259615e-01 | **+3.2770406e-01** | | |
| ΔX [Ω] | -6.1586749e-01 | -5.6657895e-01 | | |

**ΔR is the gated row** — ours is within 1.5834% of the
closed form (ceiling 2%; 1.5834% on the `MAT-6` step-3 record)
and within 1.39e-08 relative of the pinned
`+3.2770406e-01 Ω`.
...
| Check | σ = 100 S/m | σ = 0 |
|---|---|---|
| Ohmic power in the slab ∫(σ/2)\|E\|² dV [W] | 1.385836e-01 | 0.000000e+00 |
| max \|J\| in the domain [A/m²] | 6.839562e+02 | 0.000000e+00 |
...
½ ΔR I'² = 1.385836e-01 W from the reaction integral vs
1.385836e-01 W from the solved field —
ratio 1.0000.
...
| Item | Ours (FEM) | AED |
|---|---|---|
| Elements | 138619 tetrahedra, lowest-order Nédélec edge elements (`N1curl`, degree 1) | |
| Adaptive passes | n/a — fixed graded mesh | |
| Final energy error | n/a | |
| Solve time | 28.6 s (loaded) + 27.1 s (free) at `mpiexec -n 2` | |
| Drive current I' | 0.919666 A against the nominal 1.0 A | |
