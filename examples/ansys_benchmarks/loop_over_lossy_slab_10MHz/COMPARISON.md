# ANS-1 — comparison table (our half filled, both AED halves blank)

Generated by `01_loop_over_lossy_slab_10MHz.py` on 2026-08-31T11:03:42Z; every
...
| Solve time | 27.3 s (loaded) + 25.6 s (free) at `mpiexec -n 2` | | |
