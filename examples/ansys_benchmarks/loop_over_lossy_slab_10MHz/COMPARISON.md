...
Generated by `01_loop_over_lossy_slab_10MHz.py` on 2026-09-06T17:05:39Z; every
...
|---|---|---|---|---|---|
| R, σ_slab = 100 S/m [Ω] | — (closed form gives ΔZ only) | +3.2170989e-01 |  |  |  |
| X, σ_slab = 100 S/m [Ω] | — | +9.0327236e+00 |  |  |  |
| R, σ_slab = 0 [Ω] | — | +0.0000000e+00 |  |  |  |
| X, σ_slab = 0 [Ω] | — | +9.5968918e+00 |  |  |  |
| **ΔR** [Ω] | +3.2259615e-01 | **+3.2170989e-01** |  |  |  |
| ΔX [Ω] | -6.1586749e-01 | -5.6416824e-01 |  |  |  |



**ΔR is the gated row** — ours is within 0.2747% of the
closed form (ceiling 2%; 1.5834% on the `MAT-6` step-3 record)
and within 3.53e-10 relative of the pinned
`+3.2170989e-01 Ω`.

**ΔX is reported, never gated.** Ours is a ratio 0.9161 of the
...
| Check | σ = 100 S/m | σ = 0 |
|---|---|---|
| Ohmic power in the slab ∫(σ/2)\|E\|² dV [W] | 1.362234e-01 | 0.000000e+00 |
| max \|J\| in the domain [A/m²] | 6.678046e+02 | 0.000000e+00 |
...
½ ΔR I'² = 1.362234e-01 W from the reaction integral vs
1.362234e-01 W from the solved field —
ratio 1.0000.
...
|---|---|---|---|
| Elements | 418888 tetrahedra, lowest-order Nédélec edge elements (`N1curl`, degree 1) |  |  |
...
| Solve time | 118.4 s (loaded) + 124.0 s (free) at `mpiexec -n 8` |  |  |
