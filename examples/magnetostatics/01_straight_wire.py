...
def _check_vtx_roundtrip(bp_path, B_lag, V_lag, comm):
    ...
    OPS-48 (2026-09-16): ported to the adios2 2.12 bindings.  The pre-2.10
    top-level ``adios2.ADIOS()`` was removed when the image moved to dolfinx
    0.11 / adios2 2.12.1; the identical low-level classes now live under
    ...
    if failure is not None:
        # OPS-48: a read-back failure is a failure of the EX-14 anchor, not a
