...
- **The same three gates pass at both Larmor frequencies on the same
  ...
  numbers private, adjudication owed to the 2026-09-06 weekly review).
...
- **The birdcage's port S-matrix at 10 / 64 / 128 MHz is a gated
  ...
  and awaits the weekly review's adjudication), any
...
| `TH-16` | **Symmetry planes: per-face PEC / PMC on cut faces with port rescaling** — HFSS *Perfect E* / *Perfect H* symmetry; quarter the birdcage, the one lever against the 62 GiB F-human wall — **feature ladder B2** (operator directive 2026-09-04) | ⬜ | standard |
