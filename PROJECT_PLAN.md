...
1. **`ANS-2` step 4 — the phantom h-halving diagnostic: does our driven-point
...
2. **`TH-17` step 1 — eigenmodes of the loaded F-small birdcage with the PEC
