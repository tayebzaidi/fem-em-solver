...
**`PORT-14` — lumped RLC sheets (HFSS *Lumped RLC*)** ⬜ *(**feature ladder
...
**`PORT-15` — the circuit layer (HFSS + Circuit)** ⬜ *(**feature ladder
A3**, operator directive 2026-09-04; serial on `PORT-13` ✅ for the 32×32.)*
...
2. **`PORT-14` step 1 — a complex `Z_p` on a terminated lumped sheet, and
...
3. **`PORT-15` step 1 — the circuit layer's algebra with no FEM in it:
