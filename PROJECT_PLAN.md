...
at 1e-9 — open, diagnosed, **still unverified on any commit since
08-18**; item 3 makes them observable. §2 moved only editorially (the
...
3. **`TH-13` step 3a‴ — split `test_coil_loading_degree2.py` so the two
