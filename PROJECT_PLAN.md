...
| `OPS-18` | DolfinX version upgrade, recurring (0.7.2 → newest qualifying; operator directive 2026-08-16) | 🟡 **step 1 ✅ 2026-08-22** — `0.11.0.post0` builds and boots in both modes on `attempt/OPS-18` (`c767171`), negative control fires; `main` still boots 0.7.2 by design until step 3. Steps 2 (API migration; red baseline measured at `124 collected / 75 errors`, 71 of them the one `gmshio` move) and 3 (re-gate) open. | heavy |
...
2. **`OPS-18` step 2 — API migration (standard; expect > 1 slot; depends
