...
5. **DONE 2026-08-20 (12:00 slot)** — `EX-26` ✅ **and the chunk closes**:
   ...
   **Cost:** the underlying tests ran 8 s + 152 s; XDMF + docrefs
   ...
   stop.
6. **ATTEMPTED AGAIN 2026-08-21 (19:30 slot)** — `OPS-17` step 3 leg (b2)
   attempt 7 🟡: the operator flag executed as written — `coil_loading_*`
