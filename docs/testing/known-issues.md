...
| **Resolves with** | A `WF-6` step 1b commissioned by a review: either re-estimate the covariance on a rotation-invariant sample (the honest reading of candidate (a)) or demonstrate the asymmetry is in the field (candidate (b)). The 5% band must not be moved without one of those measurements in hand. |
